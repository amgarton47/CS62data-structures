/**
 * A card class representing a standard playing card with numbers 2-10, Jack,
 * Queen, King, Ace and four suits.
 * 
 * @author Dr. Dave
 *
 */
public class Card {
	...
	/**
	 * Create a new card with number and suit. If the a valid suit/number is not
	 * input, the card defaults to 1 of hearts.
	 * 
	...
	/**
	 * Returns the cards number, changing Jack, Queen, King, Ace appropriately.
	 * 
	...
	/**
	 * Flip the card over. If the card is face down it becomes face up and vice
	 * versa.
	 */
	public void flip() {
		faceUp = !faceUp;
	...
	private boolean isValidSuit(String s) {
		return s.equals("spades") || s.equals("hearts") || s.equals("clubs") || s.equals("diamonds");
	}

	/**
	 * The value of this card for the flippy card game. Numbers have their number as
	 * the value, Ace is 11, and Jack, Queen, and King are 10.
	 * 
