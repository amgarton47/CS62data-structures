...
public class CoinSorter extends JFrame {
	...
	public void paint(Graphics g) {
		...
		for (int i = 0; i < strip.size(); i++)
			g2.fill(strip.elementAt(i));

		g2.setPaint(BOUNDARY_COLOR);
		for (int i = 0; i < strip.size(); i++)
			g2.draw(strip.elementAt(i));
