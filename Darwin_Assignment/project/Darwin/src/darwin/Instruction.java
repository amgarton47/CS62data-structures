 ...
 * an opcode and an address. For instructions that do not perform jumps (hop,
 * left, right, infect), the address part is not used.
 * 
...
public class Instruction {
	...
	/**
	 * Creates a new instruction for operations that do NOT require an address.
	 * 
	 * @pre 0 < opcode <= GO.
	 */
