...
public class PomonaRunner {
	private static final String PACKAGE = "darwin";			// CHANGE for each project
	private static final String TESTER_1 = "CreatureAutograder";
	private static final String TESTER_2 = "SpeciesAutograder";
	private static final String TESTER_3 = "WorldAutograder";
		...
		try {
			...
			LauncherDiscoveryRequest request = LauncherDiscoveryRequestBuilder.request().
				...
				selectors(selectPackage(PACKAGE), 
						selectClass(Class.forName(PACKAGE+"."+TESTER_1))
